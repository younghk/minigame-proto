...
1. ~~테마 확정~~ → `docs/theme-direction.md`에 방향 정리 (코믹 몬스터 추천)
2. ~~블루프린트 작성~~ → MVP 수직슬라이스 완성 (2026-04-16)
3. ~~프로젝트 초기 세팅~~ → Unity 6 LTS + URP 3D + unity-mcp 완료
4. 플레이 테스트 + 밸런스 튜닝
5. 아트 방향 확정 → 프리미티브에서 저폴리 모델로 교체
6. AdMob 통합 + 모바일 빌드 테스트
